<div class="page-title-box">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h4 class="page-title mb-1">DATA RETUR</h4>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Daftar Retur</h4>
...
<div class="modal fade" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            <form  action="<?php echo base_url('admin/tambahRetur')?>" method="post">
...
<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            <form  action="<?php echo base_url('admin/editRetur')?>" method="post">
                <div class="modal-header">
...
<script>
    $(document).ready(function(){
        $("#tableAjax").dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo base_url('admin/getTabelJsonRetur')?>" , 
            "sPaginationType": "full_numbers",
            "order": [[ 0, "desc" ]]
        });
    })
    function modalEditRetur(id){
        $.ajax({
            type: "post",
            url: "<?php echo base_url('admin/modalEditRetur')?>",
            data: "id="+id,
            dataType: "json",
            success: function(data){
                $("#e_id").val(data['ID_RETUR']);
    ...
    function deleteData(id){
        if(confirm('Yakin menghapus pembelian? Detail retur juga akan dihapus.')){
            window.location.href="<?php echo base_url('admin/hapusRetur/')?>"+id;
        }
    }
</script>