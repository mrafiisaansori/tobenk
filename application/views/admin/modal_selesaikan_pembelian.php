                        ...
                        <?php if($detailPembelian){?>
                            ...
                            <?php foreach($detailPembelian as $dp){?>
                                <tr>
                                    ...
                                    <?php $produk = $this->Admin_model->getProdukById($dp->ID_PRODUK);?>
                                    <td><?php echo formatRupiah($produk->HARGA_BELI);?></td><?php $nominalLama = $produk->STOK * $produk->HARGA_BELI;?>
                                    <?php $harga_saran = ($nominalBaru+$nominalLama)/($dp->QTY + $produk->STOK);?>
