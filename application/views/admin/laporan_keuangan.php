			...
			<div class="row">
			    <div class="col-xl-3">
			        <div class="card">
			            ...
			            <div class="card-body">
			                <form action="<?php echo site_url('admin/LaporanTransaksiKeuangan'); ?>" method="post" id="form-beli">
			               		<div>
			    ...
			    <div class="col-xl-9">
			        <div class="card">
			        	<h6 class="card-header bg-transparent border-bottom mt-0"><b>Laporan Keuangan</b></h6>
			            <div class="card-body">
