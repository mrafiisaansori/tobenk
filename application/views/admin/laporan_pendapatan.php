<div class="page-title-box"> 
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h4 class="page-title mb-1">Laporan Pendapatan</h4>
			...
			<div class="row">
			    <div class="col-xl-3">
			        <div class="card">
			            ...
			            <div class="card-body">
			                <form action="<?php echo site_url('urgent/dolaporanpendapatan'); ?>" method="post" id="form-beli">
			               		<div>
		                            ...
		                            <div class="form-group form-group-custom mb-1">
		                            	...
		                            	<h5 class="font-size-14">Status</h5>
																	<select name="status" id="" class="form-control">
																			...
																			<option value="0">Pembatalan</option>
																	</select>
		                            </div>
			    ...
			    <div class="col-xl-9">
			        <div class="card">
			        	<h6 class="card-header bg-transparent border-bottom mt-0"><b>Laporan Pendapatan</b></h6>
			            <div class="card-body">
