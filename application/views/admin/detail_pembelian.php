                                ...
                                <?php if ($detail_pembelian) { ?>
                                    ...
                                    <?php foreach ($detail_pembelian as $db) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $db->UKURAN; ?></td>
                                            <td><?php echo formatRupiah($db->HARGA_BELI); ?></td>
                                            <td><?php echo $db->QTY; ?></td><?php $jumlah += $db->QTY;
                                                                            $nominal += $db->HARGA_BELI * $db->QTY; ?>
            ...
            <form action="<?php echo base_url('admin/tambahDetailPembelian/' . $id_pembelian) ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select id="produk_detail" name="produk_detail" class="form-control" required onchange="getHargaBeli()">
...
<script>
    ...
    function getHargaBeli() {
        $.ajax({
            ...
            data: "id_produk_detail=" + $("#produk_detail").val(),
            cache: false,
            success: function(msg) {
